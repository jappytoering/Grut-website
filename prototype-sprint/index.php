...
<head>
    ...
    <title>Prototype sprint | Grut Designers</title>
    <meta name="description" content="In 1 week van idee naar een door jouw klanten getest product. Maak gebruik van de Adviesvoucherregeling en krijg 50% vergoed."/>
    
    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="Prototype sprint | Grut Designers"/>
    <meta property="og:description" content="In 1 week van idee naar een door jouw klanten getest product. Maak gebruik van de Adviesvoucherregeling en krijg 50% vergoed."/>
    ...
    <div class="standalone-overlay">
        <div class="overlay-header">
            <div style="display: flex; align-items: center; gap: 16px;">
                ...
                <span class="header-title" style="font-family: var(--font-heading); font-size: clamp(1rem, 1.5vw, 1.1rem); font-weight: 500; color: var(--color-yellow);">Prototype sprint</span>
            </div>
        ...
        <div class="overlay-content-container">
            ...
            <div class="overlay-flexible-content">
                    ...
                    <div class="hero-slider__slides" id="heroSliderSlides">
                        <div class="hero-slider__slide is-active" data-index="0">
                            ...
                            <div class="hero-slider__content">
                                <h3 class="hero-slider__title">Met Figma, Claude code en Google tools</h3>
                            </div>
                        </div>
                        <div class="hero-slider__slide" data-index="1">
                            ...
                            <div class="hero-slider__content">
                                <h3 class="hero-slider__title">Van idee naar klikbaar prototype</h3>
                            </div>
                        </div>
                        <div class="hero-slider__slide" data-index="2">
                            ...
                            <div class="hero-slider__content">
                                <h3 class="hero-slider__title">Validatie bij echte klanten</h3>
                            </div>
                        </div>
                        <div class="hero-slider__slide" data-index="3">
                            ...
                            <div class="hero-slider__content">
                                <h3 class="hero-slider__title">Experts met 10 jaar ervaring</h3>
                            </div>
                        </div>
                        <div class="hero-slider__slide" data-index="4">
                            ...
                            <div class="hero-slider__content">
                                <h3 class="hero-slider__title">Onze ervaring gecombineerd met jullie kennis</h3>
                            </div>
                        </div>
                    </div>
                ...
                <h3 style="margin-top: 3rem; margin-bottom: 12px; font-size: 1.4rem; font-weight: 600; font-family: var(--font-heading); color: rgba(255,255,255,0.9);">Hoe het werkt?</h3>
                <p style="margin-bottom: 1.5rem; color: #ffffff; line-height: 1.6;">Samen met jouw team, onze jarenlange ontwikkelervaring en de kracht van generative AI brengen we jouw idee, bij jou op kantoor, in vijf dagen tot leven. Bovendien testen we het gelijk met medewerkers en klanten:</p>
                <ul style="list-style: none; padding: 0; margin-bottom: 2rem; color: #ffffff; line-height: 1.6;">
                    <li style="margin-bottom: 0.5rem; display: flex; align-items: flex-start; gap: 8px;"><span style="color: var(--color-green, #10b981);">✓</span> Gefocust sprinttraject: In 5 dagen gaan we van denkwerk naar een getest en gevalideerd product</li>
                    <li style="margin-bottom: 0.5rem; display: flex; align-items: flex-start; gap: 8px;"><span style="color: var(--color-green, #10b981);">✓</span> Korte lijnen: we schakelen dagelijks met jouw medewerkers, klanten en belangrijke stakeholders</li>
                    <li style="margin-bottom: 0.5rem; display: flex; align-items: flex-start; gap: 8px;"><span style="color: var(--color-green, #10b981);">✓</span> Samen sturen: we houden presentatiemomenten om feedback om te zetten naar vervolgstappen</li>
                    <li style="margin-bottom: 0.5rem; display: flex; align-items: flex-start; gap: 8px;"><span style="color: var(--color-green, #10b981);">✓</span> Echte feedback: we houden interviews met jouw klanten en laten hen het prototype testen.</li>
                    <li style="display: flex; align-items: flex-start; gap: 8px;"><span style="color: var(--color-green, #10b981);">✓</span> Tastbaar resultaat: je eindigt met een werkend product én waardevolle nieuwe inzichten</li>
                </ul>

                <h3 style="margin-top: 3rem; margin-bottom: 12px; font-size: 1.4rem; font-weight: 600; font-family: var(--font-heading); color: rgba(255,255,255,0.9);">Waarde toevoegen binnen enkele uren</h3>
                <p style="margin-bottom: 16px;">We hebben een programma samengesteld waarmee we maximale impact maken op jouw organisatie. Gevormd door onze jarenlange ervaring in developmentteams, combineren we brainstormtechnieken met de SCRUM-werkwijze en de MVP-aanpak. We brengen complexe eisen en belangen snel in kaart, schatten de toegevoegde waarde in en valideren de software direct bij echte eindgebruikers.</p>

                <h3 style="margin-top: 3rem; margin-bottom: 12px; font-size: 1.4rem; font-weight: 600; font-family: var(--font-heading); color: rgba(255,255,255,0.9);">Werken met echte klanten</h3>
                <p style="margin-bottom: 16px;">Je hebt een idee, maar mist de tijd of capaciteit om uit te zoeken of het écht aanslaat. Voordat je investeert in een langdurig ontwikkeltraject, wil je zeker weten of je doelgroep erop zit te wachten. Door het product direct voor te leggen aan jouw klanten, toetsen we razendsnel de waarde en krijgen we inzicht in de wensen van jouw doelgroep. Die feedback verwerken we direct in korte ontwikkelloops naar een optimale versie.</p>
                ...
                <h3 style="margin-top: 3rem; margin-bottom: 1.5rem; font-size: 1.4rem; font-weight: 600; font-family: var(--font-heading); color: rgba(255,255,255,0.9);">Ons traject in het kort</h3>
                <div class="modal-meta-list" style="margin-top: 0; margin-bottom: 3rem;">
                    <div class="modal-meta-item">
                        <span class="modal-meta-label">Doorlooptijd:</span>
                        <span class="modal-meta-value">5 werkdagen</span>
                    </div>
                    <div class="modal-meta-item">
                        <span class="modal-meta-label">Aanpak:</span>
                        <span class="modal-meta-value">Snel van ontwerp naar validatie</span>
                    </div>
                    <div class="modal-meta-item">
                        <span class="modal-meta-label">Expertise:</span>
                        <span class="modal-meta-value">Brainstorms, UX design, AI development, usertests</span>
                    </div>
                    <div class="modal-meta-item">
                        <span class="modal-meta-label">Inzet:</span>
                        <span class="modal-meta-value">80 uur inzet door experts</span>
                    </div>
                    <div class="modal-meta-item">
                        <span class="modal-meta-label">Resultaat:</span>
                        <span class="modal-meta-value">Door klant getest product</span>
                    </div>
                </div>
                <h3 style="margin-top: 3rem; margin-bottom: 12px; font-size: 1.4rem; font-weight: 600; font-family: var(--font-heading); color: rgba(255,255,255,0.9);">AI-kracht samen met ervaren regisseurs</h3>
                <p style="margin-bottom: 1.5rem; color: #ffffff; line-height: 1.6;">Dankzij de combinatie van Figma en moderne AI-development (zoals Claude Code en Antigravity) bouwen we in dagen wat voorheen maanden kostte. Iets in elkaar zetten met AI is tegenwoordig niet zo moeilijk meer; de echte uitdaging zit in structuur, kwaliteit en haalbaarheid. Met onze ontwikkelervaring zorgen we voor een schaalbare architectuur, een behapbare scope en een resultaat dat implementeerbaar is.</p>
                <ul style="list-style: none; padding: 0; margin-bottom: 2rem; color: #ffffff; line-height: 1.6;">
                    <li style="margin-bottom: 0.5rem; display: flex; align-items: flex-start; gap: 8px;"><span style="color: var(--color-green, #10b981);">✓</span> Schaalbare design systems: herbruikbare componenten</li>
                    <li style="margin-bottom: 0.5rem; display: flex; align-items: flex-start; gap: 8px;"><span style="color: var(--color-green, #10b981);">✓</span> Veilige code-omgeving: draait op eigen servers</li>
                    <li style="margin-bottom: 0.5rem; display: flex; align-items: flex-start; gap: 8px;"><span style="color: var(--color-green, #10b981);">✓</span> Gestructureerde workflows: strakke kaders en processen</li>
                    <li style="display: flex; align-items: flex-start; gap: 8px;"><span style="color: var(--color-green, #10b981);">✓</span> Scherpe inventarisatie: overzicht bij complexe belangen</li>
                </ul>
                ...
                <div style="position: relative; width: 100%; border-radius: 16px; overflow: hidden; margin-bottom: 3rem; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                    ...
                    <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.4); display: flex; align-items: center; justify-content: center; padding: 2rem; text-align: center;">
                        <h3 style="color: #ffffff; font-size: 1.8rem; font-weight: 600; font-family: var(--font-heading); margin: 0; line-height: 1.2; max-width: 90%;">Iedereen kan code genereren, maar wij zorgen voor toegevoegde waarde voor jouw klant</h3>
                    </div>
                </div>

                <h3 style="margin-top: 3rem; margin-bottom: 1.5rem; font-size: 1.4rem; font-weight: 600; font-family: var(--font-heading); color: rgba(255,255,255,0.9);">Wat kun je verwachten?</h3>
                <!-- Opsomming blok -->
                <div class="prototype-columns-block">
                    <div class="column">
                        <h4>Wat leveren we</h4>
                        <ul>
                            <li><span class="check">✓</span> Concreet actieplan</li>
                            <li><span class="check">✓</span> Klikbaar prototype</li>
                            <li><span class="check">✓</span> Echte gebruikerstesten</li>
                            <li><span class="check">✓</span> Werkende applicatie</li>
                            <li><span class="check">✓</span> 80 ontwikkeluren</li>
                        </ul>
                    </div>
                    <div class="divider"></div>
                    <div class="column">
                        <h4>De waarde voor jou</h4>
                        <ul>
                            <li><span class="check">✓</span> Zekerheid in 5 dagen</li>
                            <li><span class="check">✓</span> Minimaal ontwikkelrisico</li>
                            <li><span class="check">✓</span> Direct klantinzicht</li>
                            <li><span class="check">✓</span> Kennis van MVP-denken</li>
                            <li><span class="check">✓</span> Kennis van AI</li>
                        </ul>
                    </div>
                </div>

                <h4 style="margin-bottom: 0.5rem; margin-top: 3rem; color: rgba(255, 255, 255, 0.9); font-size: 1.4rem; font-weight: 600;">Is jouw kwestie geschikt voor de sprintvorm?</h4>
                <p style="margin: 0.5rem 0 1rem 0; color: #ffffff; line-height: 1.6;">De sprint is ideaal voor het valideren van slimme tools en flows: van configurator, rekentool of keuzehulp tot gestroomlijnde onboarding, vernieuwde checkouts en handige AI-features. Twijfel je of jouw idee hier tussen past? <a href="mailto:letsgo@grutdesigners.nl" style="color: var(--color-yellow); text-decoration: underline; text-underline-offset: 4px;">Mail ons</a> jouw idee. In een korte gezamenlijke <a href="mailto:letsgo@grutdesigners.nl" style="color: var(--color-yellow); text-decoration: underline; text-underline-offset: 4px;">haalbaarheidscheck</a> schatten we snel in of het concept geschikt is voor ons programma.</p>
                <ul style="list-style: none; padding: 0; margin: 0 0 2rem 0; color: #ffffff; line-height: 1.6;">
                    <li style="margin-bottom: 0.75rem; display: flex; align-items: center; gap: 10px;">
                        ...
                        <span>Perfect voor offertetools, onboarding en de digitalisering van processen</span>
                    </li>
                    <li style="margin-bottom: 0.75rem; display: flex; align-items: center; gap: 10px;">
                        ...
                        <span>We doen altijd een inschatting op haalbaarheid</span>
                    </li>
                    <li style="margin-bottom: 0.75rem; display: flex; align-items: center; gap: 10px;">
                        ...
                        <span>Veel ervaring in het inschatten van ontwikkelscopes</span>
                    </li>
                </ul>
                ...
                <div class="prototype-highlight-block">
                    <div class="highlight-content">
                        <h3>10 jaar ervaring in usertests en softwareanalyses</h3>
                        <ul>
                            <li><span class="check">✓</span> Data-analyses</li>
                            <li><span class="check">✓</span> Meerdere testprincipes</li>
                            <li><span class="check">✓</span> Via Teams</li>
                        </ul>
                    </div>
                ...
                <h4 style="margin-bottom: 1.5rem; margin-top: 3rem; color: rgba(255, 255, 255, 0.9); font-size: 1.4rem; font-weight: 600;">Programma</h4>
                <!-- Opsomming van dagen -->
                <div class="prototype-days-list">
                    <details class="day-item">
                        <summary>
                            <div class="day-label-container">
                                <div class="day-label">Dag 1</div>
                                <div class="day-divider"></div>
                                <div class="day-desc-title">Verkenning & brainstorm</div>
                            </div>
                            <span class="day-icon">
                        ...
                        <div class="day-content">
                            <p>We trappen samen af. Wat is de kern van je idee, voor wie lossen we een probleem op en welke cruciale vragen willen we na vijf dagen beantwoord hebben? We bepalen de scope en scherpen de doelstelling aan.</p>
                        </div>
                    </details>
                    <details class="day-item">
                        <summary>
                            <div class="day-label-container">
                                <div class="day-label">Dag 2</div>
                                <div class="day-divider"></div>
                                <div class="day-desc-title">Schetsen, ontdekken & bouwen</div>
                            </div>
                            <span class="day-icon">
                                <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path></svg>
                            </span>
                        ...
                        <div class="day-content">
                            <p>Wij gaan aan de slag achter de schermen. We vertalen de input naar een doordacht UX-concept, schetsen de belangrijkste user flows en selecteren de juiste tech-stack en AI-tools om de bouw te versnellen.</p>
                        </div>
                    </details>
                    <details class="day-item">
                        <summary>
                            <div class="day-label-container">
                                <div class="day-label">Dag 3</div>
                                <div class="day-divider"></div>
                                <div class="day-desc-title">Interne validatie & doorontwikkeling</div>
                            </div>
                            <span class="day-icon">
                                <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path></svg>
                            </span>
                        ...
                        <div class="day-content">
                            <p>Tijd om het idee tot leven te wekken. Met behulp van moderne AI-coding bouwen we in één dag een volledig interactief, klikbaar en werkend prototype op het gekozen device (mobiel of desktop).</p>
                        </div>
                    </details>
                    <details class="day-item">
                        <summary>
                            <div class="day-label-container">
                                <div class="day-label">Dag 4</div>
                                <div class="day-divider"></div>
                                <div class="day-desc-title">Usertesting & Advies</div>
                            </div>
                            <span class="day-icon">
                                <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path></svg>
                            </span>
                        ...
                        <div class="day-content">
                            <p>We leggen het prototype voor aan echte eindgebruikers uit jouw doelgroep. Wat snappen ze meteen? Waar haken ze af? En vooral: lost dit hun probleem écht op? We verzamelen ongefilterde data en reacties.</p>
                        </div>
                    </details>
                    <details class="day-item">
                        <summary>
                            <div class="day-label-container">
                                <div class="day-label">Dag 5</div>
                                <div class="day-divider"></div>
                                <div class="day-desc-title">MVP & Next steps</div>
                            </div>
                            <span class="day-icon">
                                <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path></svg>
                            </span>
                        ...
                        <div class="day-content">
                            <p>We zetten alle testresultaten en data op een rij. Tijdens een interactieve eindpresentatie laten we zien wat werkt, waar kansen liggen en geven we een onderbouwd advies: vol doorontwikkelen, gericht bijsturen of direct stoppen. Uiteraard leveren we de software op zodat jij het kan gebruiken.</p>
                        </div>
                    </details>
                </div>
                ...
                <p style="margin-bottom: 1.5rem; color: #ffffff; line-height: 1.6;">Met Grut haal je meer dan tien jaar hands-on ervaring per persoon in huis op het snijvlak van strategische UX, online marketing en productontwikkeling. We hebben talloze digitale projecten geleid en weten precies hoe je complexe vraagstukken terugbrengt tot de essentie. We combineren diepgaande ontwerpkennis met slimme AI-development om snel, scherp en zonder omwegen echte waarde voor jouw doelgroep te creëren.</p>
                <ul style="list-style: none; padding: 0; margin-bottom: 2rem; color: #ffffff; line-height: 1.6;">
                    <li style="margin-bottom: 0.5rem; display: flex; align-items: flex-start; gap: 8px;"><span style="color: var(--color-green, #10b981);">✓</span> 2 experts met 10 jaar ervaring in softwareontwikkeling</li>
                    <li style="margin-bottom: 0.5rem; display: flex; align-items: flex-start; gap: 8px;"><span style="color: var(--color-green, #10b981);">✓</span> In educatie, bouw, retail en e-commerce</li>
                    <li style="display: flex; align-items: flex-start; gap: 8px;"><span style="color: var(--color-green, #10b981);">✓</span> Kennis van AI development, UX design en online marketing</li>
                </ul>
                <div style="position: relative; width: 100%; border-radius: 16px; overflow: hidden; margin-top: 2rem; margin-bottom: 3rem; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                    <img src="../assets/werkplek-jurrit.jpg?v=2" class="tall-on-mobile" alt="Wat wij inbrengen" loading="lazy" decoding="async" width="1600" height="900" style="width: 100%; aspect-ratio: 16/9; display: block; object-fit: cover;">
                    <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.4); display: flex; align-items: center; justify-content: center; padding: 2rem; text-align: center;">
                        <h3 style="color: #ffffff; font-size: 1.8rem; font-weight: 600; font-family: var(--font-heading); margin: 0; line-height: 1.2; max-width: 90%;">Design ambacht in combi met generative AI</h3>
                    </div>
                </div>

                <h4 style="margin-bottom: 1.5rem; margin-top: 3rem; color: rgba(255, 255, 255, 0.9); font-size: 1.4rem; font-weight: 600;">Veelgestelde vragen</h4>
                <!-- FAQ -->
                <div class="prototype-faq">
                    <details class="prototype-faq-item">
                        <summary>Is er veel voorkennis nodig van AI? <span class="prototype-faq-icon"><svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path></svg></span></summary>
                        <div class="prototype-faq-content">
                            <p>Nee. Jij brengt de kennis in over jouw bedrijf, product en markt. Wij combineren dat met onze expertise in marketing, UX design, development en AI. In de eerste dagen ontdekken we samen de kern van de casus. Daarna gaan we bouwen en scherpen we het concept direct aan met feedback van jouw medewerkers en klanten.</p>
                        </div>
                    </details>
                    <details class="prototype-faq-item">
                        <summary>Wat als het niet afkomt? <span class="prototype-faq-icon"><svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path></svg></span></summary>
                        <div class="prototype-faq-content">
                            <p>We bouwen vaste checkmomenten in tijdens de sprint. Mocht blijken dat een idee toch niet haalbaar is, dan kunnen we op tijd bijsturen of het project stopzetten. Ons uitgangspunt is vertrouwen: we geloven sterk in deze werkwijze en zetten alles op alles om in één week een waardevol resultaat neer te zetten. Mocht er iets onvoorziens gebeuren, dan lossen we dat altijd in goed overleg op.</p>
                        </div>
                    </details>
                    <details class="prototype-faq-item">
                        <summary>Kunnen jullie na deze 5 dagen verder helpen? <span class="prototype-faq-icon"><svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path></svg></span></summary>
                        <div class="prototype-faq-content">
                            <p>Absoluut. Het geteste prototype is geen eindpunt, maar het fundament. We sluiten de sprint af met een concreet vervolgadvies en een heldere roadmap voor de technische realisatie. Vanuit daar kunnen we het product direct samen met jou doorontwikkelen tot een volwaardige productie-app, of de documentatie, het design system en de code naadloos overdragen aan jouw eigen developmentteam.</p>
                        </div>
                    </details>
                    <details class="prototype-faq-item">
                        <summary>Hebben jullie dit jaar nog tijd? <span class="prototype-faq-icon"><svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path></svg></span></summary>
                        <div class="prototype-faq-content">
                            <p>We doen maximaal 20 van deze intensieve trajecten per jaar, zodat we elk project met 100% focus en energie kunnen draaien. We hebben dit jaar nog een beperkt aantal plekken beschikbaar. Daarom doen we vooraf altijd een korte haalbaarheidscheck: we stappen alleen in als we overtuigd zijn van een grote slagingskans.</p>
                        </div>
                    </details>
                    <details class="prototype-faq-item">
                        <summary>Hoeveel tijd ben ik zelf kwijt aan dit project? <span class="prototype-faq-icon"><svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path></svg></span></summary>
                        <div class="prototype-faq-content">
                            <p>Reken op ongeveer twee gezamenlijke werksessies van elk een dagdeel. Daarnaast stemmen we 4 tot 5 keer per week een halfuurtje af met jou of een betrokken medewerker, en voeren we korte gesprekken met een aantal klanten. We richten een gedeeld kanaal (zoals WhatsApp of Teams) in om snel data en feedback uit te wisselen. De voorbereiding kost je circa 2 uur. Uiteraard geldt: hoe meer tijd en input jij erin steekt, hoe rijker het eindresultaat.</p>
                        </div>
                    </details>
                    <details class="prototype-faq-item">
                        <summary>Wat kost het? <span class="prototype-faq-icon"><svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path></svg></span></summary>
                        <div class="prototype-faq-content">
                            <p>De investering bedraagt € 4.999,- (excl. btw). Gevestigd in Fryslân? Maak dan gebruik van de <a href="https://www.snn.nl/zakelijke-subsidies/adviesvoucherregeling-fryslan-2025-2027" target="_blank" rel="noopener noreferrer" style="color: var(--color-yellow); text-decoration: underline; text-underline-offset: 4px;">Adviesvoucherregeling Fryslân (SNN)</a> om 50% subsidie te ontvangen, waardoor de sprint je slechts € 2.499,- kost.</p>
                        </div>
                    </details>
                </div>
            ...
            <h4 style="margin-bottom: 1.5rem; margin-top: 3rem; color: rgba(255, 255, 255, 0.9); font-size: 1.4rem; font-weight: 600;">Investering</h4>
            <div style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.05); border-radius: 24px; padding: 2rem; margin-bottom: 3rem;">
                <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                    ...
                    <div>
                        ...
                        <div style="font-size: var(--body-size); color: #ffffff; font-weight: 600;">€ 4.999,-</div>
                    </div>
                    <div>
                        ...
                        <div style="font-size: var(--body-size); color: #ffffff;">1 à 2 uurtjes</div>
                    </div>
                    <div>
                        ...
                        <div style="font-size: var(--body-size); color: #ffffff;">Enkele dagdelen (in de sprint) hebben we jouw kennis nodig.</div>
                    </div>
                    <div>
            ...
            <h4 style="margin-bottom: 0.5rem; margin-top: 3rem; color: rgba(255, 255, 255, 0.9); font-size: 1.4rem; font-weight: 600;">Twijfel je nog?</h4>
            <p style="margin-bottom: 16px;">
                We worden altijd enthousiast van ambitieuze plannen en denken graag vrijblijvend met je mee. Wie weet levert een kort gesprek je direct waardevolle nieuwe inzichten op. Stuur een appje of een mailtje naar <a href="mailto:letsgo@grutdesigners.nl" style="color: var(--color-yellow); text-decoration: underline; text-underline-offset: 4px;">letsgo@grutdesigners.nl</a> en we nemen snel contact op. 
            </p>
            <p style="margin-bottom: 16px;">
                <strong>Ben jij Friese MKB ondernemer?</strong> Maak dan gebruik van de <a href="https://www.snn.nl/zakelijke-subsidies/adviesvoucherregeling-fryslan-2025-2027" target="_blank" rel="noopener noreferrer" style="color: var(--color-yellow); text-decoration: underline; text-underline-offset: 4px;">Adviesvoucherregeling</a> (aangeboden door SNN) voor innovatietrajecten en krijg 50% korting op het traject.
            </p>
            <p style="margin-bottom: 16px;">
                <strong>Let op: We hebben dit jaar nog capaciteit voor 3 trajecten, dus wees er snel bij 🚀</strong>
            </p>

            <!-- Nieuw CTA Blok -->
            <div class="prototype-cta-block">
                <div class="prototype-cta-grid" style="display: flex; flex-direction: column; align-items: center; text-align: center; gap: 1.5rem;">
                    <div class="cta-header" style="display: flex; flex-direction: column; align-items: center; gap: 1rem;">
                        <span style="font-family: var(--font-body); font-size: var(--body-size); color: #C7CBD1; font-weight: 500;">Heb jij een goede casus?</span>
            ...
            <div class="prototype-trusted-block" style="margin-top: 3rem; display: flex; align-items: center; justify-content: center; width: 100%; flex-wrap: wrap; gap: 2rem;">
                <p style="font-family: var(--font-body); font-size: var(--body-size); color: rgba(255,255,255,0.6); margin: 0; white-space: nowrap;">Wij werkten al voor:</p>
